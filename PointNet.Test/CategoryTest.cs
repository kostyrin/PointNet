    ...
    public class CategoryTest
    {
        ...
        public void CategoryCreateTest()
        {
            using (var lifetime = container.BeginLifetimeScope())
            {
                ...
                CreateOrUpdateCategoryCommand command = mapper.Mapper.Map<CreateOrUpdateCategoryCommand>(category);
        ...
        public void CategoryDeleteTest()
        {
            using (var lifetime = container.BeginLifetimeScope())
            {
                ...
                DeleteCategoryCommand command = mapper.Mapper.Map<DeleteCategoryCommand>(category);
